...
This script uses urllib.request to obtain the html raw content from each couuse.
...
Uses html to load a Exception called 'http.client.RemoteDisconnected', which arises when your behavior is recognized as a spider and thus denied the access by the server.
